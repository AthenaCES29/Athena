        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    verbose_name='ID')),
                ('Id', models.CharField(
                    help_text=b'Id do Aluno', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    verbose_name='ID')),
                ('Id', models.CharField(
                    help_text=b'Id da Submissao', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    verbose_name='ID')),
                ('Id', models.CharField(
                    help_text=b'Id do Professor', max_length=50)),
                ('nome', models.CharField(
                    help_text=b'Nome do Professor', max_length=50)),
                ('user', models.ForeignKey(
                    help_text=b'Usu\xc3\xa1rio de login relacionado ao' +
                    'Professor',
                    on_delete=django.db.models.deletion.CASCADE,
                    to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno', models.ForeignKey(
                    help_text=b'Aluno inscrito na atividade',
                    on_delete=django.db.models.deletion.CASCADE,
                    to='Athena.Aluno')),
                ('atividade', models.ForeignKey(
                    help_text=b'Atividade do aluno',
                    on_delete=django.db.models.deletion.CASCADE,
                    to='Athena.Atividade')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arquivo_codigo', models.FileField(
                    upload_to=Athena.models.submissao_path)),
                ('resultado', models.CharField(
                    choices=[
                        (b'AC', b'Aceito'),
                        (b'TLE', b'Tempo Limite Excedido'),
                        (b'RTE', b'Erro em tempo de execu\xc3\xa7\xc3\xa3o'),
                        (b'CE', b'Erro de compila\xc3\xa7\xc3\xa3o'),
                        (b'WA', b'Resposta Errada'),
                        (b'INV', b'C\xc3\xb3digo Inv\xc3\xa1lido')],
